    ...
    return(
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <label>
                    <span>Nome:</span>
                    <input type='text' name='diplayName' placeholder='Nome do usuario' required onChange={(e)=>setDisplayName(e.target.value)} value ={displayName}/>
                ...
                <label>
                    ...
                    <input onChange={(e)=>setConfirmaSenha(e.target.value)} value ={confirmaSenha}type='password' name ='confirmaSenha' placeholder='Confirme sua senha' required/>
                </label>
